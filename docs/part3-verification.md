...
**Замечания:**
1. На момент аудита ссылка «последняя проверка CI» вела на конкретный run
   (`actions/runs/30296945914`). В финальной версии она заменена на устойчивую
   ссылку на вкладку Actions: `https://github.com/iurii-izman/replyline/actions`.
