...
2. отделяет core creators от визуальных референсов, смежных тематик и выбросов;
3. строит портрет по эстетике, подаче, контенту и операционной пригодности;
4. использует сохранённый исследовательский snapshot или live-поиск;
5. исключает дубли с исходной базой и ранжирует кандидатов прозрачной формулой;
6. формирует персональный оффер на основе наблюдаемого факта;
7. останавливается перед отправкой и требует подтверждения менеджера.
...
производные seed-аннотации не опубликованы. Публичный demo использует
синтетический XLSX, а найденные кандидаты сохранены как датированный snapshot с
источниками и уровнем уверенности.
...
|---|---:|
| Поиск блогеров | 2 ч |
| Автоматизация процесса | 35 мин |
| Прошлые работы | 1 ч 45 мин |
| Общая упаковка | 1 ч |
| **Итого** | **5 ч 20 мин** |
